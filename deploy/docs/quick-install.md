...
이 절차는 [배포 모델과 신규 프로젝트 표준](./deployment-models.md)의 canonical fresh로
새 Ubuntu 24.04 LTS AMD64 VM 한 대에 새 ThreadHub 인스턴스를 설치하는
fresh installation only 절차입니다. 기존 프로젝트 데이터를 이전하거나 OCI
