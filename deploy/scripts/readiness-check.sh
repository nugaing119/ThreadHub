...
assert_container_setting MM_SERVICESETTINGS_ENABLETESTING false
assert_container_setting MM_RATELIMITSETTINGS_ENABLE true
assert_container_setting MM_RATELIMITSETTINGS_VARYBYHEADER X-Real-IP
