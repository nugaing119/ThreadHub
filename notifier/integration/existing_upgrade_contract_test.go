...
func TestExistingUpgradeHarnessCoversExactReversibleTransition(t *testing.T) {
	...
	for _, phase := range []string{
		...
		"reviewed-runtime-validation", "reviewed-runtime-empty",
		"reviewed-runtime-missing", "reviewed-runtime-not-directory",
		"reviewed-runtime-privileged-only", "reviewed-runtime-symlink",
