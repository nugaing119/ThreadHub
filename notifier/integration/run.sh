...
[[ "${go_repository}" == golang && "${go_tag}" == 1.26.8-bookworm ]] || abort_run NF-HARNESS-config
[[ "${notifier_version}" == 0.2.1 && "${plugin_id}" == com.threadhub.channel-email-notifier ]] || abort_run NF-HARNESS-config
